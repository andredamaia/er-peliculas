<template>
  <div> 
    <div id="app" >
      ...
      <header>
        <div class="logo">
          <img src="./assets/logo.png" alt="ER-Películas">
        </div>
          <div class="menu">
            <ul>
              <li>
    ...
    <div class="bg-gray">
      <div class="container">
        <div class="row">
          <div class="col-12 col-md-6">
            <a href="https://api.whatsapp.com/send?phone=5547999248823" target="_blank"><img src="./assets/img-fale-conosco 1.png" alt=""></a>
          </div>
    ...
    <footer>
      <div class="container">
        <div class="row">
          ...
          <div class="col-12 text-center">
            <a href="https://www.instagram.com/er_peliculas/" target="_blank" class="button-black"> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-instagram"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"></rect><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"></path><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"></line></svg> </a>
            <a href="https://www.facebook.com/erpeliculas/?ref=br_rs" target="_blank" class="button-black"> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-facebook"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"></path></svg></a>
